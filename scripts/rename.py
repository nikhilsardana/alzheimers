#Nikhil Sardana
#8/19/17
#Write commands to text file to move and rename files.
...
for myclass in classes:
    ...
    for k in filenames:
        ...
        if "Resting_State_fMRI" in k:
            ...
            cp.write("mv data/" + keyword + "/" + myclass + "/subj_" + str(i) +"/filtered_func_data.nii" + " data/" +
                keyword + "/" + myclass +"/" + myclass + "_subj_" + str(i) + "_data.nii" + "\n")
