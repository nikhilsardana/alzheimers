...
for myclass in classes:
    ...
    for k in filenames:
        ...
        if "Resting_State_fMRI" in k:
            ...
            cp.write("mv data/" + keyword + "/" + myclass + "/subj_" + str(i) +"/filtered_func_data.nii" + 
            " data/" + keyword + "/" + myclass + "/subj_" + str(i) +"/" + myclass + "_subj_" + str(i) "_data.nii" + "\n")
