#Nikhil Sardana
#8/19/17
#Write commands to split 4d nii files into 3d nii files.
...
#chosen by np.random.choice(total_files, number_of_testing_files)
...
for myclass in classes:
    ...
    for k in filenames:
        ...
        if "Resting_State_fMRI" in k:
            ...
            cp.write("fslsplit data/" + keyword + "/" + myclass +"/" + myclass + "_subj_" + str(i) + "_data "
                "data/" + keyword + "/" + myclass +"/" + myclass + "_subj_" + str(i) + "_slice_" + "\n")
